...
public class DBWriter implements Runnable {
    ...
    private boolean updateBalanceInfo( BalanceInfo balanceInfo ) throws SQLException {
        ...
        updateStatement.setInt( 2, balanceInfo.getBalance() );
    ...
    private boolean addBalanceInfo( BalanceInfo balanceInfo ) throws SQLException {
        ...
        insertStatement.setInt( 3, balanceInfo.getBalance() );
        try {
    ...
    private void saveBalanceChanges( List<BalanceInfo> balanceInfoList ) throws SQLException {
    ...
    public void saveChanges( List<BalanceInfo> balanceInfos ) {
        ...
        while (true) {
            try {
                ...
                if (command instanceof List) {
                    saveBalanceChanges((List) command);
                } else {// must be stop
                    break;
                }
